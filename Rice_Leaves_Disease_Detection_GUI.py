...
windo.iconbitmap(r'C:\Users\prajw\Desktop\iotagriculture\Disease_Detection_In_Rice_Leaves-main\Disease_Detection_In_Rice_Leaves-main\images\rice.ico')
windo.resizable(0,0)
...
def upload_im():
    try:
        ...
        resized = im.resize(size, PIL.Image.LANCZOS)
...
ri = PIL.Image.open(r'C:\Users\prajw\Desktop\iotagriculture\Disease_Detection_In_Rice_Leaves-main\Disease_Detection_In_Rice_Leaves-main\images\rice.png')
ri =ri.resize((351,263), PIL.Image.LANCZOS)
